...
const CARD6_VARIANTS = {
  A: [
    'Projection and milestone: trajectory is {traj}. Upgrade to unlock projected scoring and handicap ranges.',
    'Projection and milestone: current trajectory is {traj}. Upgrade for score and handicap projections.',
    'Projection and milestone: trajectory shows {traj}. Upgrade to unlock projection ranges.',
    'Projection and milestone: trajectory is {traj}. Upgrade to view projected scoring in 10 rounds.',
    'Projection and milestone: trajectory is {traj}. Upgrade to unlock handicap projection ranges.',
    'Projection and milestone: trajectory is {traj}. Upgrade to see projected score bands by mode.',
    'Projection and milestone: trajectory is {traj}. Upgrade to unlock full projection detail.',
    'Projection and milestone: trajectory is {traj}. Upgrade to unlock score and handicap targets.',
    'Projection and milestone: trajectory is {traj}. Upgrade for projected score and handicap tracking.',
    'Projection and milestone: trajectory is {traj}. Upgrade to view projections and ranges.',
  ],
  B: [
    'Projection and milestone: at current trajectory, target about {score} over the next ~10 rounds with handicap near {hcp}.',
    'Projection and milestone: current trend projects about {score} in the next ~10 rounds with handicap near {hcp}.',
    'Projection and milestone: scoring pace targets about {score} over ~10 rounds with handicap around {hcp}.',
    'Projection and milestone: projected target is about {score} in ~10 rounds with handicap near {hcp}.',
    'Projection and milestone: next ~10 rounds target is about {score}, with handicap tracking near {hcp}.',
    'Projection and milestone: current trajectory points to about {score} over ~10 rounds with handicap near {hcp}.',
    'Projection and milestone: projected scoring target is about {score} with handicap near {hcp} over ~10 rounds.',
    'Projection and milestone: current trend targets about {score} over the next ~10 rounds, handicap near {hcp}.',
    'Projection and milestone: projection target is about {score} in ~10 rounds with handicap near {hcp}.',
    'Projection and milestone: current pace targets about {score} with handicap near {hcp} over ~10 rounds.',
  ],
  C: [
    'Projection and milestone: trajectory is {traj}. Log at least 10 rounds to unlock projected ranges.',
    'Projection and milestone: trajectory is {traj}. Add rounds to unlock score and handicap projections.',
    'Projection and milestone: trajectory is {traj}. Reach 10 rounds to unlock projection targets.',
    'Projection and milestone: trajectory is {traj}. Log more rounds to unlock projection bands.',
    'Projection and milestone: trajectory is {traj}. Add rounds to unlock score projections by mode.',
    'Projection and milestone: trajectory is {traj}. Log additional rounds to unlock handicap projection.',
    'Projection and milestone: trajectory is {traj}. Build to 10 rounds for projection ranges.',
    'Projection and milestone: trajectory is {traj}. More rounds unlock projected targets.',
    'Projection and milestone: trajectory is {traj}. Keep logging to unlock projected score and handicap.',
    'Projection and milestone: trajectory is {traj}. Log 10 rounds to unlock projection ranges.',
  ],
} as const;
