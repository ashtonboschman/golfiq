...
export default function ScreenshotCarousel() {
  ...
  const screenshots: Screenshot[] = [
    ...
    { src: '/photos/round_stats_2.png', alt: 'GolfIQ Round Stats - Detailed' },
    { src: '/photos/add_round_quick_simple.png', alt: 'GolfIQ Add Round - Quick & Simple' },
    { src: '/photos/add_round_quick_advanced.png', alt: 'GolfIQ Add Round - Quick & Advanced' },
    { src: '/photos/add_round_hole_by_hole_simple.png', alt: 'GolfIQ Add Round - Hole by Hole Simple' },
    ...
    { src: '/photos/user_details_1.png', alt: 'GolfIQ User Profile - Overview' },
    { src: '/photos/user_details_2.png', alt: 'GolfIQ User Profile - Stats' },
