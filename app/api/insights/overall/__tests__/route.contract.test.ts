...
function makeRound(index: number) {
  ...
  return {
    ...
    roundStrokesGained: {
      sgTotal: 0.4 - index * 0.03,
      sgOffTee: 0.2 - index * 0.01,
      sgApproach: 0.1 - index * 0.01,
      sgPutting: 0.05 - index * 0.01,
      sgPenalties: -0.02 + index * 0.005,
      sgResidual: 0.07 - index * 0.005,
      confidence: 'medium',
